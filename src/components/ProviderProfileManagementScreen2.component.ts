  ...
  template: `
    <div class="overflow-hidden bg-white" role="main">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="bg-white w-[400px] rounded-lg shadow p-6">
            ...
            <div class="mb-6">
              ...
              <div class="bg-gray-50 p-4 rounded">
                <p class="mb-2"><span class="font-medium">NPI Number:</span> 1234</p>
                <p class="mb-2"><span class="font-medium">Specialty:</span> Lorem ipsum</p>
                <p><span class="font-medium">Contact Details:</span> +1234567890</p>
              </div>
            </div>
            ...
            <div class="mb-6">
              ...
              <div class="bg-gray-50 p-4 rounded">
                <p class="mb-2"><span class="font-medium">State License Number:</span> 1234</p>
                <p class="mb-2"><span class="font-medium">Expiration Date:</span> January 1 2026</p>
                <p class="mb-2"><span class="font-medium">Issuing Board:</span> lorem ipsum</p>
                <p><span class="font-medium">Status:</span> <span class="text-green-500">Active</span></p>
              </div>
            </div>

            <!-- Action Buttons -->
            <div class="space-y-2">
              <button class="w-full py-2 px-4 bg-gray-100 rounded flex items-center justify-between">
                Certifications
                <span>›</span>
              </button>
              <button class="w-full py-2 px-4 bg-gray-100 rounded flex items-center justify-between">
        ...
        <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded shadow-lg">
          <div class="flex">
            <div class="flex-shrink-0">⚠️</div>
            <div class="ml-3">
              <p class="text-sm text-yellow-700">Upcoming expiration lorem ipsum door sit.</p>
            </div>
        ...
        <div class="bg-red-50 border-l-4 border-red-400 p-4 rounded shadow-lg">
          <div class="flex">
            ...
            <div class="ml-3">
              <p class="text-sm text-red-700">Missing credential lorem ipsum door sit.</p>
            </div>
            <button class="ml-auto">×</button>
          </div>
        </div>
...
export class ProviderProfileManagementScreen2
...
bootstrapApplication(ProviderProfileManagementScreen2);