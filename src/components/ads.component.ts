  ...
  template: `
   <div class="overflow-hidden bg-white">
    ...
    >
      ...
      <div class="flex flex-wrap gap-4 items-start mt-5 max-w-full w-[563px]">
        <!-- Time selection -->
        <div
      ...
      <div class="mb-6">
        <label class="block font-semibold mb-2">Set a minimum number of appointments booked within a chosen duration</label>
        <div class="flex items-center space-x-4">
          <select class="border rounded p-2">
            <option>24 hours</option>
            <option>48 hours</option>
          </select>
          <input type="number" placeholder="Number of appointments" class="border rounded p-2 w-32">
        </div>
      </div>
      <!-- Form Submission Requirement -->
      <div class="mb-6">
        <label class="block font-semibold mb-2">Specify a minimum form submission requirement</label>
