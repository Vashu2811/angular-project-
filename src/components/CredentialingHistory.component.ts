            ...
            <header class="self-stretch px-9 py-5 w-full bg-white max-md:px-5 max-md:max-w-full">
              <div class="flex gap-5 max-md:flex-col">
                  <h1 class="text-2xl font-semibold text-slate-700 w-[42%] max-md:w-full max-md:mt-10 pt-6">
                    Credentialing History & Reporting
                  </h1>
            ...
            <section class="mt-11 w-full max-w-[1042px] max-md:mt-10 max-md:max-w-full">
              <div class="flex flex-wrap gap-5 justify-between mb-8">
                <form class="flex flex-wrap gap-4 items-end">
                  ...
                  <div class="flex flex-col min-w-[240px]">
                    <label for="toDate" class="mb-2 text-base tracking-wide text-neutral-400">To Date</label>
                    <input type="date" id="toDate" class="px-3.5 py-3 text-sm font-medium rounded-lg bg-slate-100 text-neutral-400" />
                  </div>
                  <button type="submit" class="px-12 py-3 text-sm font-medium text-white bg-blue-600 rounded-3xl">Filter</button> 
                <button class="px-12 py-3 text-sm font-medium text-white bg-blue-600 rounded-3xl">Export Report</button>
              ...
              <table class="w-full text-sm" role="table">
                <thead>
                  <tr class="text-slate-400 font-medium">
                    ...
                    <th class="text-left w-[174px] py-4">License Status</th>
                    <th class="text-left w-[174px] py-4">License Expiration</th>
                    <th class="text-left w-[174px] py-4">Insurance Network Status</th>
                    <th class="text-left w-[174px] py-4">Last Verification Check</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  </tr><tr  class="border-b border-gray-100">
                    <td class="py-4">Michel Smith</td>
                    <td class="py-4 text-green-400">Active</td>
                    <td class="py-4">January 1 2025</td>
                    <td class="py-4 text-green-400">In-Network</td>
...
export class CredentialingHistory {
  onSubmit() {
