...
@Component({
  ...
  <div class="grid grid-cols-2 gap-6">
      ...
      <div class="text-center">
        <div class="text-gray-500">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 11c0-1.1-.9-2-2-2s-2 .9-2 2 .9 2 2 2 2-.9 2-2zm9 7a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
        </div>
        <p class="mt-2 text-sm font-semibold text-gray-700">Insurance card front</p>
    ...
    <div class="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50">
      <div class="text-center">
        ...
        <p class="mt-2 text-sm font-semibold text-gray-700">Insurance card back</p>
        <p class="text-xs text-gray-400">JPEG, PNG, PDF</p>
      </div>
    </div>
  </div>
  ...
  <div class="space-y-4">
    <div>
      ...
      <input type="text" class="w-full px-4 py-2 mt-1 border rounded-lg bg-gray-50" value="Jackson D." readonly />
    </div>
    <div>
      <label class="block text-sm font-medium text-gray-700">Insurance ID number</label>
      <input type="text" class="w-full px-4 py-2 mt-1 border rounded-lg bg-gray-50" value="1234" readonly />
    </div>
    <div>
    ...
    <div>
      ...
      <textarea rows="4" class="w-full px-4 py-2 mt-1 border rounded-lg bg-gray-50" readonly>bla bla bla</textarea>
    </div>
  </div>

  <!-- Verify Button -->
  <div class="flex justify-center">
    <button class="px-6 py-2 text-white bg-blue-500 rounded-lg hover:bg-blue-600">Verify</button>
  </div>
</div>
