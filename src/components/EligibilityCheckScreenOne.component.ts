              ...
              <table class="w-full text-sm" role="table">
                <thead>
                  <tr class="text-slate-400 font-medium">
                    <th class="text-left w-[174px] py-4">Name</th>
                    <th class="text-left w-[174px] py-4">Insurance ID number</th>
                    <th class="text-left w-[174px] py-4">Group number</th>
                    <th class="text-left w-[174px] py-4">Payer name</th>
                    <th class="text-left w-[174px] py-4">Status</th>
                    <th class="text-left w-[174px] py-4">Coverage details</th>
                  </tr>
                </thead>
                <tbody>
                  <tr  class="border-b border-gray-100">
                    <td class="py-4">John</td>
                    <td class="py-4">1234568</td>
                    <td class="py-4">12356</td>
                    <td class="py-4">Jackson</td>
                    <td class="py-4 text-red-500">Failed</td>
                  ...
                  <tr  class="border-b border-gray-100">
                    ...
                    <td class="py-4">12356</td>
                    <td class="py-4">Jackson</td>
                    <td class="py-4 text-green-500">Failed</td>
                    <td class="py-4 ">bla bla bla</td>
                  </tr>
                   <tr  class="border-b border-gray-100">
                    <td class="py-4">John</td>
...
export class EligibilityCheckScreenOne{
  onSubmit() {
