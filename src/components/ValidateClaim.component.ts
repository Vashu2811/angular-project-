...
@Component({
 ...
 <div class="overflow-hidden bg-white" role="main">
  ...
  <div class="w-full md:w-1/2 lg:w-2/3 space-y-6">
    <!-- Select Patient -->
    <div>
      <label class="block text-sm font-medium text-gray-600">Select Patient</label>
    ...
    <!-- CPT Codes -->
    <div>
      <label class="block text-sm font-medium text-gray-600">CPT codes</label>
      <input
        type="text"
        placeholder="1234"
    ...
    <!-- ICD Codes -->
    <div>
      <label class="block text-sm font-medium text-gray-600">ICD codes</label>
      <input
        type="text"
        placeholder="1234"
        class="block w-full mt-1 px-4 py-2 border border-gray-300 rounded-md bg-gray-100 text-gray-600 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
    ...
    <!-- PA Numbers -->
    <div>
      <label class="block text-sm font-medium text-gray-600">PA numbers</label>
      <input
        type="text"
        placeholder="1234"
        class="block w-full mt-1 px-4 py-2 border border-gray-300 rounded-md bg-gray-100 text-gray-600 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
  ...
  >
   <div class="shadow-md rounded-lg  bg-gray-100 border border-gray-200 p-2"> <h3 class="text-lg font-semibold text-blue-900">Summary</h3>
