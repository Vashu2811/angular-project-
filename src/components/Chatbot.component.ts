      ...
      <div class="flex gap-5 max-md:flex-col">
            ...
            <div class="flex flex-col py-6 border-2 border-solid bg-slate-900 border-slate-700">
              ...
              <div class="flex flex-col px-2.5 w-full">
                ...
                <div class="flex flex-col mt-14 w-full text-sm leading-6 text-white max-md:mx-1.5 max-md:mt-10">
                  ...
                  <button class="flex gap-4 px-5 py-4 mt-2.5 items-center w-fullrounded-3xl shadow-[0px_20px_60px_rgba(145,142,244,0.53)] text-slate-300" tabindex="0" aria-current="page">
                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/443f637e40fbfc3a6a5d52a8e2a873aa063061e1eb6f714dcf0f263bcea6d4e1?placeholderIfAbsent=true&apiKey=5f61ef1379d444ecbaf0fd96d5078749" alt="" class="object-contain shrink-0 aspect-square w-[26px]" />
        ...
        <main class="flex flex-col ml-5 w-[78%] max-md:ml-0 max-md:w-full">
          <div class="flex flex-col items-center w-full max-md:max-w-full">
            ...
            <section class=" w-full max-w-[1042px] max-md:mt-10 max-md:max-w-full">
              <div class="flex flex-col px-7 py-8 mt-0 w-full max-w-[1073px] max-md:px-5 max-md:max-w-full">
              <div class="chat-messages" role="log" aria-live="polite">
                <!-- Chat messages structure repeated for each message -->
                <div class="flex gap-3 items-start w-full text-base leading-relaxed text-slate-600 max-md:max-w-full">
                  <div class="flex flex-col flex-1 shrink basis-0 min-w-[240px] w-[961px]">
...
The book inspired the movie Blade Runner, though there are some key differences in plot.
                      ...
                      <div class="flex gap-3 items-center self-start min-h-[24px]">
                        <div class="gap-2 self-stretch my-auto text-base font-bold tracking-normal leading-none whitespace-nowrap text-slate-800">
                          You
                        </div>
                        <time class="self-stretch my-auto text-sm font-medium tracking-normal leading-none text-slate-400">
                          02:22 AM
                        </time>
                      </div>
                      <div class="gap-2.5 p-3 rounded-3xl bg-slate-50">
...
The book inspired the movie Blade Runner, though there are some key differences in plot.
            ...
            <form class="flex overflow-hidden flex-wrap gap-4 items-start self-center p-3 mt-5 w-full bg-white rounded-full border border-solid shadow-md border-slate-300 max-w-[1047px] max-md:max-w-full">
              <div class="flex flex-wrap flex-1 shrink gap-1 items-center basis-0 min-w-[240px] max-md:max-w-full">
                <label for="chatInput" class="sr-only">Message slothGPT</label>
                <div class="flex overflow-hidden gap-2.5 justify-center items-center self-stretch p-2 my-auto w-10 min-h-[40px] rounded-[123px]">
                  <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/46ff97f84fed7db9b5555221f6d909b2edc34ed8e9e379c859c0ad9b66e53d77?placeholderIfAbsent=true&apiKey=5f61ef1379d444ecbaf0fd96d5078749" alt="" class="object-contain self-stretch my-auto w-6 aspect-square" />
                </div>
                <input type="text" id="chatInput" placeholder="Message slothGPT..." class="flex-1 shrink self-stretch my-auto text-base font-medium tracking-normal leading-none basis-4 text-slate-600 bg-transparent border-none focus:outline-none max-md:max-w-full" />
              </div>
              <div class="flex gap-1 items-start">
                <button type="button" aria-label="Additional options" class="flex overflow-hidden gap-2.5 justify-center items-center p-2 w-10 min-h-[40px] rounded-[123px]">
                  <div class="flex self-stretch my-auto w-6 min-h-[24px]"></div>
                </button>
                <button type="submit" aria-label="Send message" class="flex overflow-hidden gap-2.5 justify-center items-center px-2 w-10 h-10 bg-blue-600 min-h-[40px] rounded-[123px]">
                  <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/b8d16ea89b8b23b4521254a1243efdbd6866d166b6f803ea59f7613023e43385?placeholderIfAbsent=true&apiKey=5f61ef1379d444ecbaf0fd96d5078749" alt="" class="object-contain self-stretch my-auto w-6 aspect-square" />
                </button>
              </div>
            </form>
            </section>
