...
@Component({
  ...
  template: `
    <div class="overflow-hidden bg-white">
      ...
      <div class="flex gap-5 max-md:flex-col">
        <div class="flex flex-col w-1/5 max-md:ml-0 max-md:w-full">
          <h1 class="self-stretch my-auto text-2xl font-semibold text-slate-700 max-md:mt-10">
            Facebook Posts
          </h1>
        </div>
        <div class="flex flex-col ml-5 w-4/5 max-md:ml-0 max-md:w-full">
          <div class="flex flex-wrap gap-8 items-center max-md:mt-10">
            <button 
              class="self-start px-6 py-4 mt-2.5 text-sm font-medium text-center text-white bg-blue-600 rounded-3xl max-md:px-5"
              tabindex="0"
            >
              Create New Post
            </button>
            <div class="flex gap-4 self-stretch px-6 py-4 my-auto text-base whitespace-nowrap shadow-lg bg-slate-100 rounded-[40px] text-slate-400 max-md:px-5">
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/1702c79614e4537fdce2d787d9f57a167344878b65aba977685c58749bb73384?placeholderIfAbsent=true&apiKey=5f61ef1379d444ecbaf0fd96d5078749"
                alt=""
            ...
            <button tabindex="0">
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/e89206fb5869c814fc904e867132e3d62f4226bd9e390dcadb9184d1185ddbe6?placeholderIfAbsent=true&apiKey=5f61ef1379d444ecbaf0fd96d5078749"
                alt="Notification"
    ...
    <div class="flex shrink-0 h-px bg-slate-200 max-md:max-w-full"></div>
          <div class="flex flex-col self-center py-6 mt-7 w-full text-sm bg-white rounded-3xl max-w-[1032px] max-md:max-w-full">
      <div class="flex flex-wrap gap-10 w-full font-medium max-w-[980px] text-slate-400 max-md:max-w-full">
      ...
      <div class="flex shrink-0 mt-3.5 h-px bg-slate-200 max-md:max-w-full"></div>
      <div class="flex flex-col mt-3.5 text-neutral-800 max-md:max-w-full">
        ...
        <div>
          <div class="flex flex-col w-full max-md:max-w-full">
            <div class="flex flex-wrap gap-10 max-w-full w-[987px]">
              ...
              <div class="flex flex-wrap flex-auto gap-10 items-center max-md:max-w-full">
            ...
            <div class="flex mt-4 w-full bg-gray-100 min-h-[1px] max-md:max-w-full"></div>
          </div>
        </div>
        <div>
          <div class="flex flex-col w-full max-md:max-w-full">
