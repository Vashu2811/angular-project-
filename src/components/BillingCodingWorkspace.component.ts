  ...
  <div class="overflow-hidden bg-white" role="main">
            ...
            <div class="flex flex-col py-6 border-2 border-solid bg-slate-900 border-slate-700">
              ...
              <div class="flex flex-col px-2.5 w-full">
                ...
                <div class="flex flex-col mt-14 w-full text-sm leading-6 text-white max-md:mx-1.5 max-md:mt-10">
                  ...
                  <button class="flex gap-4 px-5 py-4 mt-2.5 items-center w-full rounded-3xl  bg-blue-600 shadow-[0px_20px_60px_rgba(0,119,255,0.3)]" tabindex="0">
        ...
        <main class="flex flex-col ml-5 w-[78%] max-md:ml-0 max-md:w-full">
          <div class="flex flex-col items-center w-full max-md:max-w-full">
            <header class="self-stretch px-9 py-5 w-full bg-white max-md:px-5 max-md:max-w-full">
              <div class="flex gap-5 max-md:flex-col">
                  <h1 class="text-2xl font-semibold text-slate-700 w-[42%] max-md:w-full max-md:mt-10 pt-6">
                 Billing & Coding Workspace
                  </h1>
                <div class="flex flex-col ml-5 w-[58%] max-md:ml-0 max-md:w-full">
                  <div class="flex flex-wrap gap-8 items-center text-base text-slate-400 max-md:mt-10">
      ...
      <nav class="mb-6">
        <ul class="flex space-x-8">
          <li><a href="#" class="text-gray-600 hover:text-blue-600">Medications</a></li>
          <li><a href="#" class="text-gray-600 hover:text-blue-600">VOBs</a></li>
          <li><a href="#" class="text-gray-600 hover:text-blue-600">Coding Tools</a></li>
        </ul>
      </nav>
      ...
      <div class="flex justify-between items-center mb-8">
        <div class="flex items-center gap-4">
          <div>
            <label class="block text-sm text-gray-600 mb-1">Patient Name</label>
            <input
              type="text"
              placeholder="Search..."
      ...
      <div class="grid grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg p-6 shadow-sm">
          <h2 class="text-xl font-semibold text-gray-800 mb-4">Patient and Appointment Overview</h2>
          <div class="space-y-3">
            <p><span class="font-medium">Patient Name:</span> Jackson</p>
            <p><span class="font-medium">Patient Phone:</span> +1234567890</p>
            <p><span class="font-medium">Patient Email:</span> veveve</p>
            <p><span class="font-medium">Appointment Details:</span> lorem ipsum</p>
          </div>
        </div>

        <!-- Billing and Clinical Data Card -->
        <div class="bg-white rounded-lg p-6 shadow-sm">
          <h2 class="text-xl font-semibold text-gray-800 mb-4">Billing and Clinical Data</h2>
          
          <div class="mb-6">
            <div class="flex items-center justify-between mb-4">
              <h3 class="text-lg font-medium text-blue-600">Meds & Injections</h3>
          ...
          <div class="space-y-3">
            <button class="w-full py-2 px-4 text-left flex items-center justify-between hover:bg-gray-50 rounded">
        ...
        <div class="bg-white rounded-lg p-6 shadow-sm">
          <h2 class="text-xl font-semibold text-gray-800 mb-4">Tools and Resources</h2>
          
          <div class="mb-6">
            <div class="flex items-center justify-between mb-4">
              <h3 class="text-lg font-medium text-blue-600">Coding Tool</h3>
              <button class="text-gray-400">▼</button>
            </div>
