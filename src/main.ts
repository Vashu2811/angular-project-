              ...
              <table class="w-full gap-2 text-sm" role="table">
                <thead>
                  <tr class="text-slate-400 font-medium">
                    ...
                    <th class="text-left w-[174px] py-4">Primary Insurance Company</th>
                    <th class="text-left w-[174px] py-4">Primary Insurance Number ID</th>
                    <th class="text-left w-[174px] py-4">Primary Insurance Subscriber </th>
                    <th class="text-left w-[174px] py-4">Primary Insurance Relation </th>
                    <th class="text-left w-[174px] py-4">Secondary Insurance Company</th>
